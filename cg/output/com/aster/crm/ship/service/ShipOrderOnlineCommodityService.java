...
@Service
public class ShipOrderOnlineCommodityService extends BaseService<ShipOrderOnlineCommodity> {
	...
	@Override
	public void find(Page<ShipOrderOnlineCommodity> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM ship_order_online_commodity e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", ShipOrderOnlineCommodity.class);
	...
	public Collection<ShipOrderOnlineCommodity> find(Map<String, Object> params,
			Criteria filterCriteria) {
	...
	public void delete(String id) {
		ShipOrderOnlineCommodity x = (ShipOrderOnlineCommodity) this.getCurrentSession().get(
				ShipOrderOnlineCommodity.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	public void save(Collection<ShipOrderOnlineCommodity> datas) {
		...
		for (ShipOrderOnlineCommodity x : datas) {
