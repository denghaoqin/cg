...
@Service
public class ShipShipperService extends BaseService<ShipShipper> {
	...
	@Override
	public void find(Page<ShipShipper> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM ship_shipper e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", ShipShipper.class);
	...
	public Collection<ShipShipper> find(Map<String, Object> params,
			Criteria filterCriteria) {
	...
	public void delete(String id) {
		ShipShipper x = (ShipShipper) this.getCurrentSession().get(
				ShipShipper.class, id);
		x.setDeleted(true);
				this.update(x);
	}
