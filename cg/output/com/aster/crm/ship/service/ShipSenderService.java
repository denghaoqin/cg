...
@Service
public class ShipSenderService extends BaseService<ShipSender> {
	...
	@Override
	public void find(Page<ShipSender> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM ship_sender e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", ShipSender.class);
	...
	public Collection<ShipSender> find(Map<String, Object> params,
			Criteria filterCriteria) {
	...
	public void delete(String id) {
		ShipSender x = (ShipSender) this.getCurrentSession().get(
				ShipSender.class, id);
		x.setDeleted(true);
				this.update(x);
	}
