...
@Service
public class ShipOrderOnlineService extends BaseService<ShipOrderOnline> {
	...
	@Override
	public void find(Page<ShipOrderOnline> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM ship_order_online e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", ShipOrderOnline.class);
	...
	public Collection<ShipOrderOnline> find(Map<String, Object> params,
			Criteria filterCriteria) {
	...
	public void delete(String id) {
		ShipOrderOnline x = (ShipOrderOnline) this.getCurrentSession().get(
				ShipOrderOnline.class, id);
		x.setDeleted(true);
				this.update(x);
	}
