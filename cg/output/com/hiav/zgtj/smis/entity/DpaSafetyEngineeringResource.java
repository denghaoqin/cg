...
/**
 * The persistent class for the dpa_safety_engineering_resource database table.
 * 
 */
@Entity
@Table(name = "dpa_safety_engineering_resource")
public class DpaSafetyEngineeringResource implements Serializable {
