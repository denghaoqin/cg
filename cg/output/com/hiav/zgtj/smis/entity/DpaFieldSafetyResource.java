...
/**
 * The persistent class for the dpa_field_safety_resource database table.
 * 
 */
@Entity
@Table(name = "dpa_field_safety_resource")
public class DpaFieldSafetyResource implements Serializable {
