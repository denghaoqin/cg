...
/**
 * The persistent class for the dpa_safety_disclosure_ppe database table.
 * 
 */
@Entity
@Table(name = "dpa_safety_disclosure_ppe")
public class DpaSafetyDisclosurePpe implements Serializable {
