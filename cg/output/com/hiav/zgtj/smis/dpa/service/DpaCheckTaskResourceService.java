...
@Service
public class DpaCheckTaskResourceService extends BaseService<DpaCheckTaskResource> {
	...
	@Override
	public void find(Page<DpaCheckTaskResource> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_check_task_resource e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaCheckTaskResource.class);
	...
	public Collection<DpaCheckTaskResource> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaCheckTaskResource x = (DpaCheckTaskResource) this.getCurrentSession().get(
				DpaCheckTaskResource.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	public void save(Collection<DpaCheckTaskResource> datas) {
		...
		for (DpaCheckTaskResource x : datas) {
