...
@Service
public class DpaSafetyMgmtWorkStartService extends BaseService<DpaSafetyMgmtWorkStart> {
	...
	@Override
	public void find(Page<DpaSafetyMgmtWorkStart> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_safety_mgmt_work_start e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaSafetyMgmtWorkStart.class);
	...
	public Collection<DpaSafetyMgmtWorkStart> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaSafetyMgmtWorkStart x = (DpaSafetyMgmtWorkStart) this.getCurrentSession().get(
				DpaSafetyMgmtWorkStart.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	public void save(Collection<DpaSafetyMgmtWorkStart> datas) {
		...
		for (DpaSafetyMgmtWorkStart x : datas) {
