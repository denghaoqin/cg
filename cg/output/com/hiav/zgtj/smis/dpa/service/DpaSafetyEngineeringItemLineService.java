...
@Service
public class DpaSafetyEngineeringItemLineService extends BaseService<DpaSafetyEngineeringItemLine> {
	...
	@Override
	public void find(Page<DpaSafetyEngineeringItemLine> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_safety_engineering_item_line e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaSafetyEngineeringItemLine.class);
	...
	public Collection<DpaSafetyEngineeringItemLine> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaSafetyEngineeringItemLine x = (DpaSafetyEngineeringItemLine) this.getCurrentSession().get(
				DpaSafetyEngineeringItemLine.class, id);
		x.setDeleted(true);
				this.update(x);
	}

	@Override
	public void save(Collection<DpaSafetyEngineeringItemLine> datas) {
		IUser marker = ContextHolder.getLoginUser();
		Date markTime = new Date();
		Session session = this.getCurrentSession();
		
		for (DpaSafetyEngineeringItemLine x : datas) {
