...
@Service
public class DpaHiddenDangerService extends BaseService<DpaHiddenDanger> {
	...
	@Override
	public void find(Page<DpaHiddenDanger> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_hidden_danger e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaHiddenDanger.class);
	...
	public Collection<DpaHiddenDanger> find(Map<String, Object> params,
			Criteria filterCriteria) {
	...
	public void delete(String id) {
		DpaHiddenDanger x = (DpaHiddenDanger) this.getCurrentSession().get(
				DpaHiddenDanger.class, id);
		x.setDeleted(true);
				this.update(x);
	}
