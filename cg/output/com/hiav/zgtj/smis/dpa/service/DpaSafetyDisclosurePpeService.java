...
@Service
public class DpaSafetyDisclosurePpeService extends BaseService<DpaSafetyDisclosurePpe> {
	...
	@Override
	public void find(Page<DpaSafetyDisclosurePpe> page, Map<String, Object> params,
		...
		e.put("e", DpaSafetyDisclosurePpe.class);
	...
	public void delete(String id) {
		DpaSafetyDisclosurePpe x = (DpaSafetyDisclosurePpe) this.getCurrentSession().get(
				DpaSafetyDisclosurePpe.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	public void save(Collection<DpaSafetyDisclosurePpe> datas) {
		...
		for (DpaSafetyDisclosurePpe x : datas) {
