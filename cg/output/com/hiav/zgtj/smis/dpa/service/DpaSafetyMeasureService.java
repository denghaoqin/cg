...
@Service
public class DpaSafetyMeasureService extends BaseService<DpaSafetyMeasure> {
	...
	@Override
	public void find(Page<DpaSafetyMeasure> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_safety_measure e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaSafetyMeasure.class);
	...
	public Collection<DpaSafetyMeasure> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaSafetyMeasure x = (DpaSafetyMeasure) this.getCurrentSession().get(
				DpaSafetyMeasure.class, id);
		x.setDeleted(true);
				this.update(x);
	}

	@Override
	public void save(Collection<DpaSafetyMeasure> datas) {
		IUser marker = ContextHolder.getLoginUser();
		Date markTime = new Date();
		Session session = this.getCurrentSession();
		
		for (DpaSafetyMeasure x : datas) {
