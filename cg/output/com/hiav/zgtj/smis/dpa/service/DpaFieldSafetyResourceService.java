...
@Service
public class DpaFieldSafetyResourceService extends BaseService<DpaFieldSafetyResource> {
	...
	@Override
	public void find(Page<DpaFieldSafetyResource> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_field_safety_resource e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaFieldSafetyResource.class);
	...
	public Collection<DpaFieldSafetyResource> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaFieldSafetyResource x = (DpaFieldSafetyResource) this.getCurrentSession().get(
				DpaFieldSafetyResource.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	public void save(Collection<DpaFieldSafetyResource> datas) {
		...
		for (DpaFieldSafetyResource x : datas) {
