...
@Service
public class DpaSafetyMgmtWorkService extends BaseService<DpaSafetyMgmtWork> {
	...
	@Override
	public void find(Page<DpaSafetyMgmtWork> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_safety_mgmt_work e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaSafetyMgmtWork.class);
	...
	public Collection<DpaSafetyMgmtWork> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaSafetyMgmtWork x = (DpaSafetyMgmtWork) this.getCurrentSession().get(
				DpaSafetyMgmtWork.class, id);
		x.setDeleted(true);
				this.update(x);
	}

	@Override
	public void save(Collection<DpaSafetyMgmtWork> datas) {
		IUser marker = ContextHolder.getLoginUser();
		Date markTime = new Date();
		Session session = this.getCurrentSession();
		
		for (DpaSafetyMgmtWork x : datas) {
