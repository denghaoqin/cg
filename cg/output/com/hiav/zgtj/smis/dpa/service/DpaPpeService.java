...
@Service
public class DpaPpeService extends BaseService<DpaPpe> {
	...
	@Override
	public void find(Page<DpaPpe> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_ppe e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaPpe.class);
	...
	public Collection<DpaPpe> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaPpe x = (DpaPpe) this.getCurrentSession().get(
				DpaPpe.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	@Override
	public void save(Collection<DpaPpe> datas) {
