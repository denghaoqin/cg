...
@Service
public class DpaSafetyMgmtWorkResourceService extends BaseService<DpaSafetyMgmtWorkResource> {
	...
	@Override
	public void find(Page<DpaSafetyMgmtWorkResource> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_safety_mgmt_work_resource e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaSafetyMgmtWorkResource.class);
	...
	public Collection<DpaSafetyMgmtWorkResource> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaSafetyMgmtWorkResource x = (DpaSafetyMgmtWorkResource) this.getCurrentSession().get(
				DpaSafetyMgmtWorkResource.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	public void save(Collection<DpaSafetyMgmtWorkResource> datas) {
		...
		for (DpaSafetyMgmtWorkResource x : datas) {
