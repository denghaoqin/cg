...
@Service
public class DpaSafetyCheckResourceService extends BaseService<DpaSafetyCheckResource> {
	...
	@Override
	public void find(Page<DpaSafetyCheckResource> page, Map<String, Object> params,
		...
		e.put("e", DpaSafetyCheckResource.class);
	...
	public void delete(String id) {
		DpaSafetyCheckResource x = (DpaSafetyCheckResource) this.getCurrentSession().get(
				DpaSafetyCheckResource.class, id);
		x.setDeleted(true);
				this.update(x);
	}

	@Override
	public void save(Collection<DpaSafetyCheckResource> datas) {
		IUser marker = ContextHolder.getLoginUser();
		Date markTime = new Date();
		Session session = this.getCurrentSession();
		
		for (DpaSafetyCheckResource x : datas) {
