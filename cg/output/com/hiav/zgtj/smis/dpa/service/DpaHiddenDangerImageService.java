...
@Service
public class DpaHiddenDangerImageService extends BaseService<DpaHiddenDangerImage> {
	...
	@Override
	public void find(Page<DpaHiddenDangerImage> page, Map<String, Object> params,
		...
		e.put("e", DpaHiddenDangerImage.class);
	...
	public void delete(String id) {
		DpaHiddenDangerImage x = (DpaHiddenDangerImage) this.getCurrentSession().get(
				DpaHiddenDangerImage.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	public void save(Collection<DpaHiddenDangerImage> datas) {
		...
		for (DpaHiddenDangerImage x : datas) {
