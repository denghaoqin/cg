...
@Service
public class DpaDailyPlanService extends BaseService<DpaDailyPlan> {
	...
	@Override
	public void find(Page<DpaDailyPlan> page, Map<String, Object> params,
	...
	public void delete(String id) {
		DpaDailyPlan x = (DpaDailyPlan) this.getCurrentSession().get(
				DpaDailyPlan.class, id);
		x.setDeleted(true);
				this.update(x);
	}
