...
@Service
public class  extends BaseService<> {
	...
	@Override
	public void find(Page<> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM  e ")
	...
	public Collection<> find(Map<String, Object> parameter) {
	...
	@Override
	public void save(Collection<> datas) {
