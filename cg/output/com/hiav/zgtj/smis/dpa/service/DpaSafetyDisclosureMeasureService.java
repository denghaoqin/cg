...
@Service
public class DpaSafetyDisclosureMeasureService extends BaseService<DpaSafetyDisclosureMeasure> {
	...
	@Override
	public void find(Page<DpaSafetyDisclosureMeasure> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_safety_disclosure_measure e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaSafetyDisclosureMeasure.class);
	...
	public Collection<DpaSafetyDisclosureMeasure> find(Map<String, Object> params,
			Criteria filterCriteria) {
	...
	public void delete(String id) {
		DpaSafetyDisclosureMeasure x = (DpaSafetyDisclosureMeasure) this.getCurrentSession().get(
				DpaSafetyDisclosureMeasure.class, id);
		x.setDeleted(true);
				this.update(x);
	}
	...
	public void save(Collection<DpaSafetyDisclosureMeasure> datas) {
		...
		for (DpaSafetyDisclosureMeasure x : datas) {
