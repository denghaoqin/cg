...
@Service
public class DpaJobEarlyCallService extends BaseService<DpaJobEarlyCall> {
	...
	@Override
	public void find(Page<DpaJobEarlyCall> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_job_early_call e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaJobEarlyCall.class);
	...
	public Collection<DpaJobEarlyCall> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaJobEarlyCall x = (DpaJobEarlyCall) this.getCurrentSession().get(
				DpaJobEarlyCall.class, id);
		x.setDeleted(true);
				this.update(x);
	}
