...
@Service
public class DpaSafetyCheckService extends BaseService<DpaSafetyCheck> {
	...
	@Override
	public void find(Page<DpaSafetyCheck> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_safety_check e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaSafetyCheck.class);
	...
	public Collection<DpaSafetyCheck> find(Map<String, Object> params,
			Criteria filterCriteria) {
	...
	public void delete(String id) {
		DpaSafetyCheck x = (DpaSafetyCheck) this.getCurrentSession().get(
				DpaSafetyCheck.class, id);
		x.setDeleted(true);
				this.update(x);
	}
