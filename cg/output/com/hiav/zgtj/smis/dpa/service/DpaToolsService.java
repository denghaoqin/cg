...
@Service
public class DpaToolsService extends BaseService<DpaTools> {
	...
	@Override
	public void find(Page<DpaTools> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_tools e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaTools.class);
	...
	public Collection<DpaTools> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaTools x = (DpaTools) this.getCurrentSession().get(
				DpaTools.class, id);
		x.setDeleted(true);
				this.update(x);
	}
