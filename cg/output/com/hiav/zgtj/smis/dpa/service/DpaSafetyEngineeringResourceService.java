...
@Service
public class DpaSafetyEngineeringResourceService extends BaseService<DpaSafetyEngineeringResource> {
	...
	@Override
	public void find(Page<DpaSafetyEngineeringResource> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_safety_engineering_resource e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaSafetyEngineeringResource.class);
	...
	public Collection<DpaSafetyEngineeringResource> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaSafetyEngineeringResource x = (DpaSafetyEngineeringResource) this.getCurrentSession().get(
				DpaSafetyEngineeringResource.class, id);
		x.setDeleted(true);
				this.update(x);
	}

	@Override
	public void save(Collection<DpaSafetyEngineeringResource> datas) {
		IUser marker = ContextHolder.getLoginUser();
		Date markTime = new Date();
		Session session = this.getCurrentSession();
		
		for (DpaSafetyEngineeringResource x : datas) {
