...
@Service
public class DpaJobOrderService extends BaseService<DpaJobOrder> {
	...
	@Override
	public void find(Page<DpaJobOrder> page, Map<String, Object> params,
			Criteria filterCriteria) {

		StringBuilder sql = new StringBuilder(" select e.* FROM dpa_job_order e ")
			//.append(" left join pm_project p on e.project_id = p.id ")
			.append(" where e.deleted=0 ");
		Map<String, Class> e = new HashMap<String, Class>();
		e.put("e", DpaJobOrder.class);
	...
	public Collection<DpaJobOrder> find(Map<String, Object> params) {
	...
	public void delete(String id) {
		DpaJobOrder x = (DpaJobOrder) this.getCurrentSession().get(
				DpaJobOrder.class, id);
		x.setDeleted(true);
				this.update(x);
	}
